...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let solutionSearchPattern = tl.getInput('solutionSearchPattern', true);
            ...
            let matchedFiles = tl.match(allPaths, solutionSearchPattern, sourceDirectory); // default match options
